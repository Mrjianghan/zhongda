<style lang="less" scoped>
    .info{ width: 100%; height: 100%; padding: 0 0 .96rem; background-color: #eee; overflow-y: scroll;
        &-up{ width: 100%; padding: 0 .3rem .3rem; margin-bottom: .3rem; background-color: #fff;}
        &-title{ font-size: .36rem; color: #333; text-align: center; line-height: .84rem;}
        &-date{ font-size: .24rem; color: #999; line-height: 1; text-align: center;}
        &-img{ width: 100%;}
        &-content{ padding: .3rem 0; font-size: .28rem; color: #666;}
...
<template>
    <div class="info" v-title="'公告详情'">
        <div class="info-up">
            ...
            <div class="info-date">{{ announcementInfo.createDatetime }}</div>
