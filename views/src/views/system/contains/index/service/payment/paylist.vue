...
.title div{width:50%;text-align:center;}
.title div span{border-bottom:1px solid #fff;height:50px;line-height:50px;display:inline-block;opacity:0.5;}
...
.el-collapse-item__header{font-size:18px !important;color:#333 !important;height:44px !important;line-height:44px !important;}
.el-collapse-item{width:100%;}
/*.el-collapse-item__arrow{margin-right:4% !important}*/
</style>
<template>
    <div v-title="'生活缴费'">
                            ...
                            <div v-for="(item1 , index1) in item.content.part">
                                <el-collapse-item class="" :name="index1">
                                    <template slot="title">
                                        ...
                                        <span v-if="item.type==3">{{item.year}}{{ index1 === 0 ? '冬季' : index1 === 1 ? '秋季' : index===2 ? '夏季' : '春季' }}</span>
                                    </template>
        ...
        <div class="bottom flex-lr section fsize15">
            ...
            <div class="flex-rr">
                <div style="margin-right:20px">合计：<span class="mleft20">300元</span></div>
...
<script lang="babel">
    ...
    export default {
        ...
        data() {
            return {
                ...
                /*prolist:[
                    {title:'2018年冬季',
                        content:[
                            {time:'12月份',wuye:100.00,car:100.00,public:100.00},
                            {time:'1月份',wuye:100.00,car:100.00,public:100.00},
                            {time:'2月份',wuye:100.00,car:100.00,public:100.00}
                        ],
                    },
                    {title:'2018年春季',
                        content:[
                            {time:'3月份',wuye:100.00,car:100.00,public:100.00},
                            {time:'4月份',wuye:100.00,car:100.00,public:100.00},
                            {time:'5月份',wuye:100.00,car:100.00,public:100.00}
                        ],
                    },
                    {title:'2018年夏季',
                        content:[
                            {time:'6月份',wuye:100.00,car:100.00,public:100.00},
                            {time:'7月份',wuye:100.00,car:100.00,public:100.00},
                            {time:'8月份',wuye:100.00,car:100.00,public:100.00}
                        ],
                    },
                    {title:'2018年秋季',
                        content:[
                            {time:'9月份',wuye:100.00,car:100.00,public:100.00},
                            {time:'10月份',wuye:100.00,car:100.00,public:100.00},
                            {time:'11月份',wuye:100.00,car:100.00,public:100.00}
                        ],
                    },
                ],
                waterlist : [
        ...
        mounted(){
            ...
            let yearList = []
            console.log(zdlist.bills.length)
