<style lang="less" scoped>
    ...
    .contain-el-editMessage{ width: 80%; }
    .scoped{
        &-expand{ line-height: 3; text-align: left;
        ...
        <el-table stripe :data="tableData" style="width: 100%">
            <el-table-column type="expand">
                ...
                <el-row class="scoped-expand" v-for="member in props.row.memberList" :key="member.cellphone">
                    <el-col :span="4">身份：{{ member.identity === 1 ? '户主' : ((member.identity === 2 ? '家属' : '租户') + (member.isResponsible ? '(代理人)' : '')) }}</el-col>
