<template>
    <div class="contain-main">
        ...
        <el-table stripe :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="enrollDate" label="报名起止时间" min-width="330"></el-table-column>
            <el-table-column prop="activeDatetime" label="活动起止时间" min-width="330"></el-table-column>
