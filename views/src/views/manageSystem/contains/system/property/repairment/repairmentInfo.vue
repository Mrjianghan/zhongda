        ...
        <el-form ref="formData" :rules="formRules" :model="formData" label-width="100px" class="scoped-form" label-position="left">
            ...
            <el-form-item label="维修员" prop="repairMan" v-show="formData.chooseApproveType === 2" v-permit="1102">
                <el-select v-model="formData.repairMan">
                    <el-option v-for="repairMan in repairManList" :key="repairMan.value"
                        :value="repairMan.value"
                        :label="repairMan.label"></el-option>
                </el-select>
            </el-form-item>
            ...
            <!-- <el-form-item label="完成图片" prop="reportImgListComplete" v-show="(info.repairmentStatus === '维修中')" v-permit="1102">
                <el-upload
                    ...
                    :on-change="handleReportImgChangeComplete"
                    :on-remove="handleReportImgChangeComplete"
                    :before-upload="handleCheckImgLengthComplete">
            ...
            <!-- 上传转送图片 -->
            <el-form-item label="上传转送图片" prop="reportImgList" v-show="formData.chooseApproveType === 3" v-permit="1102">
                <el-upload
                    ref="uploadImg"
                    action="/v1/file"
                    list-type="picture-card"
    ...
    export default {
        ...
        methods: {
            ...
            handleCheckImgLengthComplete(file) {
                ...
                if (this.$refs['complete'].uploadFiles.length > 1) {
